...
<?php if ( $has_orders ) { ?>
	...
	foreach ( $customer_orders->orders as $customer_order ) { 
		...
		<div class="account_order">
			<span class="account_order_date">
				<?php echo esc_attr( $order->get_date_created()->date( 'd.m.Y' ) ); ?>
			</span>
			<span class="account_order_total">
				<?php if ( !empty($order->get_formatted_order_total()) ) { 
					echo 'Сумма заказа '.$order->get_formatted_order_total(); 
				} ?>
			</span>
			<?php
							...
							<div class="product-subtotal" data-title="<?php esc_attr_e( 'Subtotal', 'woocommerce' ); ?>">
								<div class="product-subtotal_price">
									<?php if (!empty($product->get_price())) { ?>
										<span class="product-subtotal_price_title">Сумма:</span>
